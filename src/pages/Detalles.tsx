        ...
        <div className="hidden mobile:block max-w-[620px] mx-auto space-y-5">
          <article className={mobileSummaryCard}>
            <img
              ...
              className="block w-full h-[210px] object-contain bg-[#f3efe9]"
            />
            <div className="p-5">
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  href="https://maps.app.goo.gl/bQm3DGNQMNdXBEXz8?g_st=iw"
                  target="_blank"
                  rel="noreferrer"
                >
                  {t.detalles.map}
              ...
              {openMobileSection === "celebration" ? (
                <div className="mt-5 pt-5 border-t border-line space-y-4">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <a
                      className={btn}
                      href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Celebraci%C3%B3n%20Gabriela%20y%20Diego&dates=20270211T213000Z/20270212T070000Z&details=Celebraci%C3%B3n%20y%20fiesta&location=Pura%20Lodge%2C%20Callej%C3%B3n%20Lagunillas%205385%2C%20San%20Pedro%20de%20la%20Paz%2C%20Chile"
                      target="_blank"
                      rel="noreferrer"
                    >
                      {t.detalles.addToCalendar}
          ...
          <div className="flex flex-col gap-28 tablet:gap-20">
            ...
            <div className="relative pl-[100px] tablet:pl-[60px] mobile:pl-[50px]">
              ...
              <article className="reveal flex flex-row tablet:flex-col bg-surface rounded-[2rem] shadow-soft border border-line overflow-hidden">
                ...
                {/* Left Side: Photo */}
                <div className="w-1/2 tablet:w-full relative min-h-[450px] tablet:min-h-[350px] mobile:min-h-[280px] bg-[#f3efe9]">
                  <img src={ceremoniaPhoto} alt={t.detalles.ceremonyPhotoAlt} className="absolute inset-0 w-full h-full object-cover object-center tablet:object-contain" />
                </div>
                ...
                <div className="w-1/2 tablet:w-full p-12 tablet:p-10 mobile:p-7 flex flex-col justify-center bg-surface">
                  ...
                  <div className="flex flex-col xl:flex-row gap-4 mt-8">
                    <a className={btn} href="https://maps.app.goo.gl/bQm3DGNQMNdXBEXz8?g_st=iw" target="_blank" rel="noreferrer">
                      {t.detalles.map}
                    </a>
              ...
              <article className="reveal flex flex-row-reverse tablet:flex-col bg-surface rounded-[2rem] shadow-soft border border-line overflow-hidden">
                ...
                <div className="w-1/2 tablet:w-full p-12 tablet:p-10 mobile:p-7 flex flex-col justify-center bg-surface">
                  ...
                  <div className="flex flex-col xl:flex-row gap-4 mt-8">
                    ...
                    <a className={btn} href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Celebraci%C3%B3n%20Gabriela%20y%20Diego&dates=20270211T213000Z/20270212T070000Z&details=Celebraci%C3%B3n%20y%20fiesta&location=Pura%20Lodge%2C%20Callej%C3%B3n%20Lagunillas%205385%2C%20San%20Pedro%20de%20la%20Paz%2C%20Chile" target="_blank" rel="noreferrer">
                      {t.detalles.addToCalendar}
                    </a>
                  </div>
